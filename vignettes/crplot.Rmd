...
The `crplot` function is part of the `conf` package.  It generates a two-dimensional confidence region plot for the specified two-parameter parametric distribution, fitted to a dataset.
